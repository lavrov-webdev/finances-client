...
export const ConfirmButton: FC<PropsWithChildren<Props>> = ({ onConfirm, confirmText, isLoading, children }) => {
  ...
  return <>
    ...
    <Popup anchorRef={buttonRef} onClose={closePopup} open={isOpen}>
      <Flex direction="column" gap={1}>
        ...
        <Button width="max" view='outlined-danger' loading={isLoading} onClick={onConfirm}>
          Подтвердить
        </Button>
      </Flex>
    </Popup>
