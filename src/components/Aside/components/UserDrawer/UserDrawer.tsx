...
export const UserDrawer = () => {
    ...
    return (
        ...
        >
            <div><b>Id</b> - {userInfoState.data.id}</div>
            <div><b>Email</b> - {userInfoState.data.email}</div>
            <Button view="outlined-danger" onClick={() => logoutMutation.mutate()}>Выйти <Icon data={ArrowRightFromSquare} /></Button>
        </Flex>
    )
}