...
export const useEnvelopesOptions = (envelopes: TGetEnvelopesWithCategoryNameAndSprintDates[]): SelectOption[] => {
    return useMemo(() => envelopes.reduce<SelectOption[]>((acc, envelope) => {
        acc.push({
