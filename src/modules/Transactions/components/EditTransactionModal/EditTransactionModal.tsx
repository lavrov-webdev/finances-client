...
import { FormAmountInput, FormDatePicker, FormProvider, FormTextInput } from '@components/Form';
...
import { EditTransactionDto, TEditTransactionDto, TEditTransactionDtoOut, TGetTransactionDto } from '@modules/Transactions/types';
...
export const EditTransactionModal: FC<Props> = ({
  ...
  const onSubmit = (data: TEditTransactionDtoOut) => {
    editTransactionMutation.mutate({ editTransaction: data, id: transaction.id })
  }
  return <Modal
    onClose={onClose}
    open={isOpen}
